...
class QuizController extends Controller
{
    ...
    public function showQuiz($courseId, $lessonId)
    {
        ...
        return view('userExpert.quiz.quiz', compact(
            'currentQuestion',
            'currentIndex',
            'questions',
            'score',
    ...
    public function submitAnswer(Request $request, $courseId, $lessonId)
    {
        ...
        if (empty($questions)) {
            return redirect()->route('expert.question.results', [$courseId, $lessonId])
        ...
        return redirect()->route('expert.quiz.show', [$courseId, $lessonId]);
    }
    ...
    public function showResults($courseId, $lessonId)
    {
        ...
        return view('userExpert.quiz.results', [
            'score' => $score,
