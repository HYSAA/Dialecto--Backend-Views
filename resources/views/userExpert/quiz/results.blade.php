                ...
                <div id="canvas-holder" style="width: 500px; height: 500px;">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 margin-tb pt-4 d-flex flex-column">
                            <a class="btn btn-back-main mb-2" href="{{ route('expert.courses.index') }}">Go back to Courses</a>
                            <a class="btn btn-main" href="{{ route('expert.quiz.show', [$course->id, $lesson->id]) }}">Retake Quiz</a>
                        </div>
                    </div>
                </div>
            </div>
