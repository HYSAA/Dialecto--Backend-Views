...
<!-- Search Bar -->
<form method="GET" action="{{ route('expert.progress', ['id' => Auth::user()->firebase_id]) }}" style="margin-bottom: 20px;">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Search Course,Lesson or Profeciency Level" value="{{ $searchQuery ?? '' }}">
            <button type="submit" class="btn btn-primary"  style="font-size: 1.2rem; padding: 10px 20px;margin-left: 10px;">Search</button>
        </div>
    </form>
    ...
    <div class="card-container"
        ...
        style="border: 1px solid #ddd; 
           ...
           margin: auto;">
            ...
            <h2 style="height: 25px;"><b>{{ $lessonData['lesson']['proficiency_level'] }}</b></h2>
