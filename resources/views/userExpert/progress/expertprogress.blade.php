...
@section('content')
    ...
    <div class="main-container">
        ...
        <!-- Search Bar -->
        <form method="GET" action="{{ route('expert.progress', ['id' => Auth::user()->firebase_id]) }}"
        ...
        @if (count($coursesWithLessonsAndContents) > 0)
            ...
            <div class="card-container"
                ...
                @foreach($coursesWithLessonsAndContents as $courseId => $courseData)
                    <h2
                        style="font-size: 1.8rem; font-weight: bold; color: #444; margin: 20px 0 10px; grid-column: 1 / -1; width: 100%;">
