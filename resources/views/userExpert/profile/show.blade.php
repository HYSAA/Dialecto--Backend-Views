    ...
    <div class="row" style="margin-bottom: 30px; border-bottom: 1px solid #e0e0e0; padding-bottom: 20px;">
        ...
        <div class="col-md-6">
            <div style="padding: 15px;">
                ...
                <span class="btn" style="font-size: 1.3rem; background-color: #d4edda; color: #155724; border-color: #c3e6cb; border-radius: 6px; padding: 10px 15px; margin-top: 10px;">
                    <i class="fas fa-check-circle" style="margin-right: 8px;"></i>Verified Expert for {{ $languageExperty }}
                </span>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div style="display: flex; justify-content: flex-end; gap: 15px; padding: 15px;">
                <a class="btn btn-primary" href="{{ route('expert.settings.edit') }}" 
