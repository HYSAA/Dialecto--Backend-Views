    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-main" href="{{ route('user.courses.show', $courseId) }}">Back To Lesson</a>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-lg-12 box-container">
            ...
            <div class="box-2">
                ...
                <div class="row">
                    @if($previousContent)
                    <a class="btn btn-back-main" style="width: 100%; margin-bottom: 5px;" type="button" href="{{ route('user.contents.show', [$courseId, $lessonId, $previousContent['id']]) }}">Previous Word</a>
                    @endif
                </div>
            </div>
