    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-main" href="{{ route('admin.lessons.show', [$course->id, $lesson->id]) }}">Back To Lesson</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 box-container ">
            ...
            <div class="box-2">
                <div class="row">
                    ...
                    <a class="btn btn-main" style="width: 100%; margin-bottom: 5px;" type="button" href="{{ route('admin.contents.show', [$course->id, $lesson->id, $nextContent->id]) }}">Next Word</a>
                    @endif
                ...
                <div class="row">
                    @if($previousContent)
                    <a class="btn btn-back-main" style="width: 100%; margin-bottom: 5px;" type="button" href="{{ route('admin.contents.show', [$course->id, $lesson->id, $previousContent->id]) }}">Previous Word</a>
